...
export default function NotFoundPage() {
  ...
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 w-screen h-screen z-0 flex items-start justify-center">
      ...
      <h1 className="absolute top-[8%] sm:top-[20%] right-20 sm:-right-10 -rotate-12 text-[30rem] sm:text-[15rem] font-extrabold tracking-tighter text-indigo-600 opacity-5">
        404
      </h1>
      <h1 className="absolute top-[50%] sm:top-[42%] right-0 sm:-right-10 -rotate-12 text-[20rem] sm:text-[12rem] font-extrabold tracking-tighter text-indigo-600 opacity-5">
        404
      </h1>
      <h1 className="absolute top-1/10 sm:top-[60%] -right-3 sm:-right-10 -rotate-12 text-[40rem] sm:text-[9rem] font-extrabold tracking-tighter text-transparent sm:text-indigo-600 opacity-5">
        404
      </h1>
      <h1 className="absolute top-1/10 sm:top-[75%] -right-3 sm:-right-10 -rotate-12 text-[40rem] sm:text-[6rem] font-extrabold tracking-tighter text-transparent sm:text-indigo-600 opacity-5">
        404
      </h1>
