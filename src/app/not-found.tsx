...
export default function NotFoundPage() {
  return (
    <div className="fixed top-0 left-0 bottom-0 right-0 w-screen h-screen z-0 flex items-start justify-center text-neutral-200">
      ...
      <div className="mt-24 xxl:mt-20  sm:w-[95%] flex flex-col gap-10 items-center justify-start z-50">
        ...
        <Link
          href="/home"
          className="flex w-full justify-center rounded-md bg-neutral-200 px-3 py-1.5 text-sm font-semibold leading-6 shadow-sm  transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white disabled:opacity-40"
        >
