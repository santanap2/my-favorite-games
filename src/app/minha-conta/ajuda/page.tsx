        ...
        <div className="flex flex-wrap gap-4">
          <div className="flex flex-col gap-4 bg-white w-80 px-6 py-4 rounded shadow-md">
            ...
            <div className="flex gap-2 items-center justify-start">
              <Clock size={28} weight="bold" className="text-teal-400" />
          ...
          <div className="flex flex-col gap-4 bg-white w-80 px-6 py-4 rounded shadow-md">
            ...
            <Link
              ...
              className="flex gap-2 items-start justify-start hover:text-teal-400 text-sm font-light"
            >
              <WhatsappLogo
                size={28}
                weight="duotone"
          ...
          <div className="flex flex-col gap-4 bg-white w-80 px-6 py-4 rounded shadow-md">
            ...
            <Link
              ...
              className="flex gap-2 items-start justify-start hover:text-teal-400 text-sm font-light"
            >
              <Envelope size={28} weight="duotone" className="text-teal-400" />
              <h3 className="flex flex-col">
