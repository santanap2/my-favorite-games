      ...
      {productIsLoading ? (
        ...
        <div className="w-full h-full">
          <div className="flex flex-wrap items-center gap-1 w-fit text-sm sm:w-full sm:text-xs max-w-full">
            <Link
              href="/"
              className="text-zinc-500 hover:text-rose-400 min-w-fit"
            >
              Todos os jogos
            </Link>
            ...
            <div className="flex flex-col justify-start items-start w-full h-full text-zinc-600 gap-2">
              ...
              <div className="flex gap-4 mt-20 sm:mt-6 sm:w-full sm:justify-center sm:items-center sm:gap-1">
                <button
                  ...
                  className="w-64 h-14 bg-rose-400 rounded text-lg font-bold uppercase tracking-wider text-white shadow-sm hover:shadow-lg sm:w-3/5 sm:font-semibold sm:text-sm sm:h-12"
                >
                  Comprar agora
                </button>
                <button
                  ...
                  className="w-14 h-14 bg-rose-400 rounded text-lg font-bold uppercase tracking-wider text-white flex items-center justify-center relative shadow-sm hover:shadow-lg sm:h-12 sm:w-12"
                >
                  <ShoppingCartSimple
                    weight="bold"
                ...
                <button
                  ...
                  className="w-14 h-14 bg-rose-400 rounded text-lg font-bold tracking-wider text-white flex items-center justify-center relative shadow-sm hover:shadow-lg sm:h-12 sm:w-12"
                >
                  <Heart
