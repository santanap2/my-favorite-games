    ...
    <div className="mt-24 xxl:mt-20 w-full h-full animation-opacity transition-all">
      ...
      <div className=" w-full h-full flex flex-col gap-10 text-zinc-800 sm:gap-6">
        <div className="flex gap-1 w-fit items-center justify-center">
          <Chat weight="fill" className="text-rose-500 sm:text-3xl text-5xl" />
        ...
        <div className="flex flex-wrap gap-4">
          <div className="flex flex-col gap-4 bg-white w-80 px-6 py-4 rounded shadow-md">
            ...
            <div className="flex gap-2 items-center justify-start">
              <Clock weight="bold" className="text-rose-400 text-3xl" />
          ...
          <div className="flex flex-col gap-4 bg-white w-80 px-6 py-4 rounded shadow-md">
            ...
            <Link
              ...
              className="flex gap-2 items-start justify-start hover:text-rose-400 text-sm font-light"
            >
              <WhatsappLogo
                weight="duotone"
          ...
          <div className="flex flex-col gap-4 bg-white w-80 px-6 py-4 rounded shadow-md">
            ...
            <Link
              ...
              className="flex gap-2 items-start justify-start hover:text-rose-400 text-sm font-light"
            >
              <Envelope weight="duotone" className="text-rose-400 text-3xl" />
              <h3 className="flex flex-col">
