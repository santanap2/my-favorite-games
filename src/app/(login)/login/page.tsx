      ...
      <div className="mt-10 sm:mx-auto w-full sm:max-w-sm flex flex-col items-center justify-center">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="flex w-full justify-center rounded-md bg-zinc-300 text-zinc-800 px-3 py-1.5 text-sm font-semibold leading-6 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white disabled:opacity-40"
        ...
        <p className="mt-10 text-center text-sm text-zinc-500">
          ...
          <Link
            href="/cadastro"
            className="font-semibold leading-6 hover hover:underline text-zinc-300"
          >
            Cadastre-se agora
          </Link>
        </p>
