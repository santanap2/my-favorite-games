              ...
              {orderIsLoading ? (
                ...
                <>
                  ...
                  <Link href={`/minha-conta/meus-pedidos/${id}`}>
                    <button className="mt-6 bg-indigo-600 text-neutral-100 sm:w-full p-3 px-12 rounded font-light shadow-md hover:bg-indigo-700 hover:shadow-lg flex gap-4 items-center justify-center">
