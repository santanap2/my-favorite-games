...
export default async function MeusFavoritos() {
  ...
  return (
    <div className="w-full h-full  border-l border-stone-800 pl-4 md:border-none md:pl-0">
      <title>{`Meus favoritos - ${pageTitle}`}</title>

      <div className=" w-full h-full flex flex-col gap-10 text-stone-300 sm:gap-6 animation-opacity transition-all">
