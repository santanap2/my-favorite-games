  ...
  return (
    <div className="w-full h-28 sm:h-32 bg-slate-800 py-1 px-4 rounded shadow-sm flex justify-between items-center xxl:px-1 xxl:justify-center xxl:flex-col xxl:gap-2 xxl:pb-1 transition-all relative">
      ...
      <div className="flex justify-between items-center w-full">
        <p className="text-xs ml-2 sm:text-zinc-400 text-transparent flex gap-2">
          <span className="uppercase font-semibold">Pedido: </span>
          <span className="bg-zinc-100 loading-skeleton rounded text-transparent cursor-default hidden sm:block">
            9999999
          </span>
        </p>
