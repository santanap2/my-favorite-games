...
export default function SingleOrderSkeleton() {
  ...
  return (
    <div className="w-full h-32 bg-white py-1 px-4 rounded shadow-sm flex justify-between items-end xxl:px-1 xxl:justify-center xxl:flex-col xxl:gap-2 xxl:pb-1">
      <table className="w-5/6 xxl:w-full flex flex-col gap-4">
        <thead className="w-full">
          <tr className="font-semibold text-sm uppercase text-transparent flex justify-between gap-2 xxl:text-xs">
            <td className="py-3 px-4 w-60 h-8 md:h-6 xxl:p-1 md:w-12 xxl:w-40 bg-zinc-100 rounded loading-skeleton sm:hidden">
            ...
            <td className="py-3 px-4 w-40 h-8 md:h-6 xxl:p-1 xxl:w-20 bg-zinc-100 rounded loading-skeleton">
              Valor
            </td>
          </tr>
        </thead>
