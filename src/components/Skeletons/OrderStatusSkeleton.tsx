  ...
  return (
    <div className="flex w-[463px] sm:max-w-full sm:w-full h-40 gap-16 items-center justify-center relative animation-opacity transition-all">
      ...
      <div className="w-20 flex flex-col gap-4 items-center justify-center absolute left-0 z-10">
        <Storefront
          weight="fill"
          className="rounded-3xl p-2 border-2 border-neutral-500 text-white0 loading-skeleton text-6xl"
        />
        <div className="flex flex-col items-center justify-center h-full">
          <Circle
            weight="fill"
            className="text-white0 rounded-3xl bg-neutral-500 text-4xl"
          />
          <span className="text-white0 text-sm text-center">
            Pedido realizado
          </span>
        </div>
      </div>
