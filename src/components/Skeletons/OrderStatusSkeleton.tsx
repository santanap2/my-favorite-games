...
export default function OrderStatusSkeleton() {
  return (
    <div className="flex w-[463px] sm:max-w-full sm:w-full h-40 gap-16 items-center justify-center text-blue-400 relative animation-opacity transition-all">
      <div className="bg-blue-400 h-2 w-[400px] absolute left-10 bottom-14 z-0 loading-skeleton sm:w-[300px] xs:w-[250px]" />
      ...
      <div className="w-20 flex flex-col gap-4 items-center justify-center absolute left-32 z-10 sm:left-24 xs:left-20">
        <CurrencyCircleDollar
          weight="fill"
          className="rounded-3xl bg-blue-400 p-2 border-2 border-zinc-200 text-zinc-300 loading-skeleton text-6xl"
        />
