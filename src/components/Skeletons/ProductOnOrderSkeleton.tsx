...
export default function ProductOnOrderSkeleton({
  ...
  return (
    ...
    >
      <div className="w-24 h-36 object-cover rounded bg-slate-100 loading-skeleton" />

      <div className="flex flex-col items-start justify-center w-full">
        <div className="flex sm:flex-col gap-0 sm:gap-1 text-transparent w-3/5 sm:w-full">
          <h1 className="font-semibold text-lg tracking-tight w-full sm:w-fit bg-slate-100 loading-skeleton rounded">
        ...
        <div className="w-full h-full flex items-start justify-between mt-1">
          <div className="flex flex-col justify-between items-start text-sm font-light sm:text-sm sm:font-light w-full h-full">
            <h3 className="rounded bg-slate-100 w-fit loading-skeleton text-transparent">
              Genero do jogo
            </h3>
            <div className="flex flex-col gap-1 text-xs max-h-16 sm:hidden  text-transparent mr-3">
              <h4 className="rounded bg-slate-100 w-fit loading-skeleton">
          ...
          <div className="font-black flex items-center justify-center text-emerald-600 tracking-wide text-lg sm:text-base sm:font-extrabold min-w-fit h-full">
            <h2 className="rounded bg-slate-100 w-fit loading-skeleton text-transparent">
              R$9999,99
            </h2>
          </div>
        </div>
