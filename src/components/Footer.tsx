...
export default function Footer() {
  return (
    <footer className="flex w-screen bg-slate-950 text-slate-100 justify-center items-center mt-16 xl:mt-12 py-4 xl:items-start z-10 animation-opacity transition-all footer-bg">
