...
export default function MyAccountPopUp() {
  return (
    <div className="w-fit bg-neutral-900 pl-4 pr-2 pt-5 pb-3 rounded-md shadow-md absolute top-11 right-0 z-50 flex flex-col gap-4 items-end justify-center text-white appear-animation animation-opacity transition-all backdrop-blur-lg bg-opacity-90">
      <ArrowFatUp
        weight="fill"
