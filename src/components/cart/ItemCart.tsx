...
export default function ItemCart({
  ...
  return (
    <div className="flex justify-between items-center w-full gap-3 border-b border-zinc-900 pb-4 sm:pb-2 animation-opacity transition-all">
      ...
      <div className="flex flex-col justify-between items-start w-full h-full">
        <div className="flex flex-col">
          ...
          <h3 className="text-sm sm:text-xs sm:font-light sm:tracking-tight text-zinc-300">
            {category.namePt}
          </h3>
        </div>
