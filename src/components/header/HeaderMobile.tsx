...
export default async function HeaderMobile() {
  ...
  return (
    <header className="hidden w-screen h-14 md:flex items-center justify-between fixed left-0 top-0 z-30 bg-neutral-950 bg-opacity-80 border-b border-neutral-800 backdrop-blur-sm text-neutral-300 px-2">
