...
export default async function HeaderMobile() {
  ...
  return (
    <header className="hidden w-screen h-14 md:flex items-center justify-between fixed left-0 top-0 z-30 bg-zinc-950 bg-opacity-80 border-b border-zinc-800 backdrop-blur-sm text-zinc-300 px-2">
