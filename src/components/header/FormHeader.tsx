  ...
  return (
    ...
    >
      <input
        ...
        type="text"
        className="bg-zinc-900 bg-opacity-40 w-full outline-none block rounded-full border-0 py-1.5 px-3 pr-10 text-zinc-300 shadow-sm ring-1 ring-inset ring-zinc-700 placeholder:text-zinc-500 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
