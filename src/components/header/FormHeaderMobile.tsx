  ...
  return (
    ...
    >
      <input
        ...
        type="text"
        className="bg-neutral-900 bg-opacity-0 w-56 outline-none block rounded-full border-0 py-1.5 px-4 pr-10 text-white shadow-sm ring-1 ring-inset ring-neutral-700 placeholder:text-neutral-700 focus:ring-2 focus:ring-inset focus:ring-indigo-700 text-sm leading-6"
