      ...
      <label htmlFor="card-number" className="w-full relative">
        <input
          ...
          className={`relative rounded w-full border  bg-zinc-50 focus:shadow-md focus:outline-none px-4 pt-4 pb-3 text-md font-light lg:text-sm ${
            errors.cardData?.cardNumber ? 'border-red-400' : 'border-teal-400'
          }`}
        />
      ...
      <label htmlFor="card-name" className="w-full relative">
        <input
          ...
          className={`relative rounded w-full border bg-zinc-50 focus:shadow-lg focus:outline-none px-4 pt-4 pb-3 text-md font-light lg:text-sm ${
            errors.cardData?.cardName ? 'border-red-400' : 'border-teal-400'
          }`}
        />
      ...
      <div className="w-full flex items-start justify-between lg:flex-col lg:gap-6">
        <label htmlFor="card-date" className="w-[47.5%] relative lg:w-full">
          <input
            ...
            placeholder="MM/AA"
            className={`relative rounded w-full border bg-zinc-50 focus:shadow-lg focus:outline-none px-4 pt-4 pb-3 text-md font-light lg:text-sm ${
              errors.cardData?.cardDate ? 'border-red-400' : 'border-teal-400'
            }`}
          />
        ...
        <label htmlFor="card-cvv" className="w-[47.5%] relative lg:w-full">
          <input
            ...
            maxLength={3}
            placeholder="000"
            className={`relative rounded w-full border border-teal-400 bg-zinc-50 focus:shadow-lg focus:outline-none px-4 pt-4 pb-3 text-md font-light lg:text-sm ${
              errors.cardData?.cardCvv ? 'border-red-400' : 'border-teal-400'
            }`}
          />
