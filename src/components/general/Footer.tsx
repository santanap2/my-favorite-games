...
export default function Footer() {
  return (
    <footer className="flex w-screen bg-neutral-950 bg-opacity-40 backdrop-blur-sm border-t border-neutral-800 text-neutral-200 justify-center items-center mt-16 xl:mt-12 py-4 xl:items-start z-10 animation-opacity transition-all text-xs">
