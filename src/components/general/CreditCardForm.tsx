    ...
    >
        ...
        <input
          ...
          className={`${
            errors.cardData?.cardNumber
              ...
              : 'ring-neutral-600'
          } bg-neutral-950 outline-none block w-full rounded-md border-0 py-1.5 px-3 shadow-sm ring-1 ring-inset ring-neutral-600 placeholder:text-neutral-700 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6`}
        />
        {errors.cardData?.cardNumber && (
      ...
      <div className="w-full">
        ...
        <select
          ...
          className="bg-neutral-950 outline-none block w-full rounded-md border-0 py-1.5 px-3 shadow-sm ring-1 ring-inset ring-neutral-600 placeholder:text-neutral-700 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
        >
