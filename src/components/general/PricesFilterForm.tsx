...
export default function PricesFilterForm({ searchParams }: ISearchParams) {
  ...
  return (
    <form
      onSubmit={formSubmit}
      id="lateral-filters"
      className="w-full flex flex-col gap-3 px-4 text-zinc-300"
    >
      ...
      <div className="w-full flex flex-col items-start gap-1">
        ...
        <input
          ...
          name="minPrice"
          placeholder="R$ 00,00"
          className="bg-transparent outline-none block w-full rounded-md border-0 py-1 px-3 shadow-sm ring-1 ring-zinc-800 ring-inset placeholder:text-zinc-700 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
      ...
      <div className="w-full flex flex-col items-start gap-1">
        ...
        <input
          ...
          type="text"
          placeholder="R$ 00,00"
          className="bg-transparent outline-none block w-full rounded-md border-0 py-1.5 px-3 shadow-sm ring-1 ring-zinc-800 ring-inset placeholder:text-zinc-700 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
          onChange={(e) => pricesHandler(e)}
      ...
      <button
        type="submit"
        className="flex justify-center rounded-md bg-zinc-300 text-zinc-800 px-20 py-1.5 text-sm font-semibold leading-6 shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white disabled:opacity-40 transition-all"
      >
        Filtrar
      </button>
    </form>
