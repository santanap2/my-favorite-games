...
export default function OrderDetails({ order }: { order: IOrderData }) {
  ...
  return (
    <div className="text-neutral-200 flex flex-col gap-1 bg-neutral-950 border border-neutral-900 w-[600px] max-w-full p-4 rounded-md shadow-md text-sm sm:w-full animation-opacity transition-all">
      <p>
