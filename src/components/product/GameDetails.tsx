...
export default function GameDetails({
  ...
  return (
    <div className="text-zinc-300 h-full flex flex-col xxl:max-w-4xl max-w-2xl w-full">
      <div className="w-full border-b border-zinc-700 py-6">
        <button
      ...
      <div className="w-full py-6">
        ...
        {expandMenus.similar && (
          ...
          >
            <CarouselPrevious className="text-zinc-300 -950 bg-zinc-300 bg-opacity-30 border-none rounded-full p-2 absolute top-auto left-0" />
            ...
            <CarouselNext className="text-zinc-300 -950 bg-zinc-300 bg-opacity-30 border-none rounded-full p-2 absolute top-auto right-0" />
          </Carousel>
        )}
      </div>
    </div>
