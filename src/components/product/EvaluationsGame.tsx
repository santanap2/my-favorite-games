      ...
      {evaluations.length > 0 ? (
        evaluations.map(
          ({
            ...
            <div
              key={id}
              className="w-full h-fit bg-neutral-950 border border-neutral-800 p-4 rounded-md shadow-md text-base text-neutral-300 flex flex-col gap-6 tracking-wide sm:p-5 lg:w-full lg:h-fit"
            >
