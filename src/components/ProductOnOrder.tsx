  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start justify-center w-full">
        <h1 className="font-semibold text-lg tracking-tight text-rose-600 w-full">
          {name}
        </h1>
        ...
        <div className="w-full h-full flex items-start justify-between">
          ...
          <div className="font-black flex items-center justify-center text-rose-600 tracking-wide text-lg sm:text-base sm:font-extrabold min-w-fit h-full">
